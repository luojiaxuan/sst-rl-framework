...
from nemo_rl.posttraining.protocol import RolloutResult, normalize_env_step_result
...
def collect_multi_turn_rollout(
    policy_generation: GenerationInterface,
    input_batch: BatchedDataDict[DatumSpec],
    tokenizer: TokenizerType,
    task_to_env: dict[str, EnvironmentInterface],
    ...
    batch, metrics = run_multi_turn_rollout(
        policy_generation=policy_generation,
...
def collect_async_multi_turn_rollout(
    policy_generation: GenerationInterface,
    input_batch: BatchedDataDict[DatumSpec],
    tokenizer: TokenizerType,
    task_to_env: dict[str, EnvironmentInterface],
    ...
    batch, metrics = run_async_multi_turn_rollout(
        policy_generation=policy_generation,
        input_batch=input_batch,
        tokenizer=tokenizer,
        task_to_env=task_to_env,
